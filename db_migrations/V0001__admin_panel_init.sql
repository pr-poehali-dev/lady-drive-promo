...
VALUES (
  ...
  'Программа обучения вождению для женщин ЛЕДИ ДРАЙВ. 70 часов практики, женщины-инструкторы, KIA RIO, рассрочка без переплат. Симферополь.',
  ...
  'Получите права красиво: 70 часов практики, женщины-инструкторы, рассрочка без переплат',
...
('courses', 'Тариф / Курсы', 'middle', '{"title":"Всё включено. Без доплат.","subtitle":"Один тариф — полная свобода выбора коробки передач","price":"85 900 ₽","hours":"70 часов практики"}', 2),
...
('partners', 'Партнёры', 'bottom', '{"title":"Наши партнёры"}', 6),
